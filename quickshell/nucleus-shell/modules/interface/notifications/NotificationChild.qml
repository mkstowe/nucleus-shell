...
Rectangle {
    ...
    border.width: 2
    border.color: root.isCritical ? Appearance.m3colors.m3outline : Appearance.m3colors.m3outlineVariant
    ...
    color: {
        ...
        if (hovered)
            return clicked ? Appearance.m3colors.m3surfaceContainerHigh : Appearance.m3colors.m3surfaceContainerLow;
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ClippingRectangle {
                ...
                MaterialSymbol {
                    ...
                    color: root.isCritical ? Appearance.m3colors.m3onError : Appearance.m3colors.m3onSurfaceVariant
            ...
            Rectangle {
                ...
                height: 20
                radius: width / 2
                color: closeHover.containsMouse ? Appearance.m3colors.m3surfaceContainerHigh : "transparent"
        ...
        StyledText {
            ...
            wrapMode: Text.Wrap
            color: root.isCritical ? Appearance.m3colors.m3onError : Appearance.m3colors.m3onSurface
            Layout.fillWidth: true
        ...
        RowLayout {
            ...
            Repeater {
                ...
                StyledButton {
                    ...
                    base_bg: index !== 0 ? Appearance.m3colors.m3secondaryContainer : Appearance.m3colors.m3primary
                    base_fg: index !== 0 ? Appearance.m3colors.m3onSecondaryContainer : Appearance.m3colors.m3onPrimary
